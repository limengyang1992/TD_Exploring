...
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset CIFAR10_flip_0.1 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset CIFAR10_flip_0.2 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset CIFAR10_flip_0.4 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset CIFAR10_flip_0.6 --epochs ${epochs}    &&\
