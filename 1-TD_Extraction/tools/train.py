...
def main():
    ...
    train_loader,test_loader,uncertain_loader,cutout_loader,num_classes = build_dataloader(args=args)
    
    # create model
    model = build_model(args.model, num_classes=num_classes, MC=False,pretrain=args.pretrain)
