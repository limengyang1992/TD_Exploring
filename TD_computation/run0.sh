...
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset KMNIST_flip_0.1 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset KMNIST_flip_0.2 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset KMNIST_sym_0.1 --epochs ${epochs}   && \
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18 --dataset KMNIST_sym_0.2 --epochs ${epochs}   \
...
# CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18_224 --dataset StanfordCars_sym_0.3 --pretrain False --epochs ${epochs}   && \
# CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18_224 --dataset StanfordCars_clean --pretrain False --epochs ${epochs}   && \
# CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python tools/train.py --model ResNet18_224 --dataset OxfordIIITPet_sym_0.1 --pretrain False --epochs ${epochs}   && \
...
CUDA_VISIBLE_DEVICES=0 python tools/train.py --model ResNet18 --dataset KMNIST_flip_0.1 --epochs 120  
CUDA_VISIBLE_DEVICES=1 python tools/train.py --model ResNet18 --dataset KMNIST_flip_0.2 --epochs 120  
CUDA_VISIBLE_DEVICES=2 python tools/train.py --model ResNet18 --dataset KMNIST_sym_0.1 --epochs 120  
CUDA_VISIBLE_DEVICES=3 python tools/train.py --model ResNet18 --dataset KMNIST_sym_0.2 --epochs 120  